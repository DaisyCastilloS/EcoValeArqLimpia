...
export interface CenterRequestRepositoryInterface {
  ...
  save: (CenterRequestToSave: CenterRequest) => Promise<void>
  ...
  // Actualiza un objeto CenterRequest en el repositorio
  update: (CenterRequestToUpdate: CenterRequest) => Promise<void>
